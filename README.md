# ORDER MATTERS: EVALUATING SEQUENTIAL POST-PROCESSING TRANSFORMATIONS ON AUDIO DEEPFAKE DETECTION
...
- [Fine-tuned AASIST weights](checkpoints/aasist/best.pth): The fine-tuned AASIST weight on our pipeline's generated data.
